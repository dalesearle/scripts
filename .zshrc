export CATALINA_HOME=/Users/dsearle/development/tomcat/9.0.39
export JAVA_HOME=/Library/Java/JavaVirtualMachines/adoptopenjdk-8.jdk/Contents/Home
export RABBITMQ_HOME=/usr/local/Cellar/rabbitmq/3.8.3
export PATH=$PATH:$JAVA_HOME/bin:$RABBITMQ_HOME/sbin
...
alias r1stop="rabbitmqctl -n rabbit1@dsearle-mbp shutdown --no-wait"
...
alias r2stop="rabbitmqctl -n rabbit2@dsearle-mbp shutdown --no-wait"
...
alias r3stop="rabbitmqctl -n rabbit3@dsearle-mbp shutdown --no-wait"
